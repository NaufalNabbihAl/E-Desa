        ...
        <div class="container">
            <div class="row align-items-center justify-content-start">
                <div class="col-lg-6 mx-auto text-center">
                    ...
                    <h1 class="heading" data-aos="fade-up">UMKM</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row mb-5">
                <div class="col-lg-6 mx-auto text-center">
                    <div class="heading-content" data-aos="fade-up">
                        <h2>Daftar UMKM</h2>
                        <p>Banyak UMKM dari Desa kami yang bisa kamu coba kunjungin. Mulai dari makanan daerah dan
                            Hiasan khas daerah kami.</p>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="service-2 left-0 mb-5">
                        <img src="{{ url('assets/images/umkm1.png') }}" alt="Image" class="img-fluid mb-4 rounded">
                        <div>
                            <h3>Buah bu Puan</h3>
                            <p>Buah berkualitas yang menggunakan pupuk banteng.</p>
                ...
                <div class="col-lg-3">
                    <div class="service-2 left-0 mb-5">
                        <img src="{{ url('assets/images/umkm2.png') }}" alt="Image" class="img-fluid mb-4 rounded">
                        <div>
                            <h3>Sayur bu Mega</h3>
                            <p>Sayur berkualitas yang menggunakan pupuk banteng.</p>
                            <p><a href="#" class="more">Learn More</a></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="service-2 left-0 mb-5">
                        <img src="{{ url('assets/images/umkm3.png') }}" alt="Image" class="img-fluid mb-4 rounded">
                        <div>
                            <h3>Biji pak Ganjar</h3>
                            <p>Biji berkualitas yang menggunakan pupuk banteng.</p>
                            <p><a href="#" class="more">Learn More</a></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="service-2 left-0 mb-5">
                        <img src="{{ url('assets/images/umkm4.png') }}" alt="Image"
                            class="img-fluid mb-4 rounded">
                        <div>
                            <h3>Permen pak Joko</h3>
                            <p>Gulali tahum 90an yang di gemari banyak anak.</p>
                            <p><a href="#" class="more">Learn More</a></p>
                        </div>
                    </div>
                </div>
