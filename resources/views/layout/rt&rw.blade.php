...
<head>
    ...
    <style>
        ...
        * {
        ...
        .container-detail-tamu {
            display: flex;
            flex-wrap: wrap;
            gap: 20px;
            /* Jarak antara custom box */
        }
...
<body>
    ...
    <div id="mySidebar" class="sidebar">
        ...
        <a href="{{ route('rtrw.index') }}">Pengumuman</a>
        <a class="active" href="laporantamu.html">Laporan Tamu</a>
    </div>
    @yield('content')
    ...
    <script>
        ...
        function routetodetaildata() {
            ...
            window.location.href = "lihatdata.html";
        }
    </script>
