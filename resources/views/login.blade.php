                ...
                <div class="p-5">
                    <form action="{{ route('login') }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control border border-black rounded-5" name="NIK"
                                id="NIK" required>
                        </div>
                        <div class="mb-3">
                            <label for="password" class="form-label fw-bold">Password</label>
                            <input type="password" class="form-control border border-black rounded-5" name="password"
                                id="password" required>
                        </div>
                        <div class="d-flex flex-row justify-content-between flex-wrap mt-4 px-1">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input border border-black" type="checkbox" id="ingatsaya"
                                    name="ingatsaya" value="ingatsaya">
