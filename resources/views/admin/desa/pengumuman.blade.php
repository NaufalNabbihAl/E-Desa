...
<body>
    ...
    <div id="mySidebar" class="sidebar">
        ...
        <a class="active" href="{{ route('desa.pengumuman') }}">Pengumuman</a>
    ...
    <div id="main">
        ...
        <div class="content">
            ...
            <div class="form-container">
                ...
                <form action="{{ route('desa.pengumumanStore') }}" method="get" onsubmit="validateForm()">
                    @csrf
    ...
    <script>
        ...
        function validateForm(e) {
            ...
            fetch("{{ route('desa.pengumumanStore') }}", {
                method: 'POST',
                body: formData
