    ...
    <div id="main">
        ...
        <header>
            <div class="header-content">
                ...
                <span class="tulisan-home">Laporan Keuangan</span>
            </div>
        </header>

        <div class="content">
            <div class="custom-box">
                <a href="{{ route('desa.tambahdatalaporankeuangan') }}" class="custom-button">Tambah data</a>
            </div>
                ...
                <tbody>
                    @foreach ($laporan as $lp)
                        <tr>
                            ...
                            <td>{{ $lp->tanggal }}</td>
                            <td>
                                <button class="lihat-button" onclick="routetodetaildata()">Lihat</button>
                                <button class="delete-button" onclick="showConfirmation()">Hapus</button>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
            ...
            <div id="successPopup" class="popup" style="display: none;">
                ...
                <p>Data laporan berhasil dihapus.</p>
                <div class="center-horizontal">
