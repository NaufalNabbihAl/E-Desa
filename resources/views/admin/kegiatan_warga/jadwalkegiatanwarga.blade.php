...
<body>
    ...
    <div id="mySidebar" class="sidebar">
        ...
        <a href="{{ route('kegiatanWarga.banksampah') }}">Bank Sampah</a>
        <a class="active"href="{{ route('kegiatanWarga.jadwalkegiatan') }}">Jadwal Kegiatan Warga</a>
    </div>
                ...
                <tbody>
                    ...
                    @foreach ($jadwal as $jd)
                        <tr>
                            ...
                            <td>{{ $jd->lokasi }}</td>
                            <td>
                                {{ $jd->waktu }} - {{ $jd->waktuSelesai }} WIB
                            </td>
                            <td>
                                {{ $jd->pembahasan }}
                            </td>
                            <td>
                                <!-- Ikon dari gambar aset dengan ukuran 20x20 piksel -->
                                <a href="{{ route('kegiatanWarga.detail', $jd->id) }}">Detail</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
    ...
    <script>
        ...
        function routetodetaildata() {
            // Ganti "halaman-tujuan.html" dengan URL atau path file dari halaman tujuan
            window.location.href = "detailkegiatanwarga.html";
        }
    </script>
