     ...
     <div id="main">
         ...
         <div class="content">
             ...
             <div class="form-container">
                 ...
                 <form action="{{ route('kegiatanWarga.update') }}" onsubmit="return validateForm()" method="put">
                     @csrf
                     @method('PUT')
                     <input type="hidden" name="id" value="{{ $jadwal->id }}">
                     <div class="form-group">
                         <label for="judul">Pelaksana:</label>
                         <input type="text" id="judul" name="judul" class="input-field"
                             value="{{ $jadwal->pelaksana }}" />
                     </div>
                     <div class="form-group">
                         <label for="isi">Lokasi:</label>
                         <input type="text" id="judul" name="waktu" class="input-field"
                             value="{{ $jadwal->lokasi }} " />
                     </div>
                     <div class="form-group">
                         <label for="judul">Waktu</label>
                         <input type="text" id="judul" name="waktu" class="input-field"
                             value="{{ $jadwal->waktu }} - {{ $jadwal->waktuSelesai }} WIB" />
                     </div>
                     <div class="form-group">
                         <label for="judul">Pembahasan</label>
                         <input type="text" id="judul" name="pembahasan" class="input-field"
                             value="{{ $jadwal->pembahasan }}" />
                     </div>
