...
<body>
    ...
    <div id="main">
        ...
        <div class="content">
            <h2>Input Data Sampah Warga</h2>
            <div class="form-container">
                <div class="form-header"></div>
                <form onsubmit="return validateForm()" action="{{ route('kegiatanWarga.store') }}" method="post">
                    @csrf
                    <div class="form-group">
                        <label for="nama">Nama Warga:</label>
                        <input type="text" id="nama" name="nama" class="input-field" placeholder="" />
                    </div>
                    <div class="form-group">
                        <label for="tanggal">Tanggal Penyetoran:</label>
                        <input type="date" id="nama" name="tanggal" class="input-field" placeholder="" />
                    </div>
                    <div class="form-group">
                        <label for="berat">Berat Sampah</label>
                        <input type="text" id="berat" name="berat" class="input-field" placeholder="" />
                    </div>
                    <div class="form-group">
                        <label for="pendapatan">Pendapatan</label>
                        <input type="text" id="pendapatan" name="pendapatan" class="input-field" placeholder="" />
                    </div>
