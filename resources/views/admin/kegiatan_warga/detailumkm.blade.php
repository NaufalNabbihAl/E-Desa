...
<body>
    ...
    <div id="mySidebar" class="sidebar">
        ...
        <a class="active" href="Index.html">UMKM</a>
        <a href="banksampah.html">Bank Sampah</a>
        <a href="jadwalkegiatanwarga.html">Jadwal Kegiatan Warga</a>
    </div>
    ...
    <div id="main">
        <header>
            <div class="header-content">
                ...
                <span class="tulisan-home">Home</span>
            </div>
        </header>
            ...
            <div class="form-container">
                ...
                <form action="{{}}" onsubmit="return validateForm()">
                        ...
                        <div class="form-col">
                            <div class="form-group">
                                ...
                                <input type="text" id="judul" name="judul" class="input-field"
                                    placeholder="Wahyu Dio" />
                            </div>
                        </div>
                        <div class="form-col">
                            <div class="form-group">
                                <label for="isi">Link Tokopedia:</label>
                                <textarea id="isi" name="isi" class="input-field" placeholder="Surabaya Tenggara"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-col">
                            <div class="form-group">
                                <label for="judul">Nomor WA:</label>
                                <input type="text" id="waktu" name="waktu" class="input-field"
                                    placeholder="13.00 - 17.00 WIB" />
                            </div>
                        </div>
                        <div class="form-col">
                            <div class="form-group">
                                <label for="judul">Link Shopee:</label>
                                <input type="text" id="pembahasan" name="pembahasan" class="input-field"
                                    placeholder="Politik Luar Desa" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-col">
                            <div class="form-group">
                                <label for="gambar-deskripsi">Gambar:</label>
                                <img id="gambar-deskripsi" src="assets/img/profile.jpg" alt="Gambar Deskripsi"
                    ...
                    <div class="form-row">
                        <div class="form-col">
                            <div class="form-group">
                                <label for="judul">Pemilik:</label>
                                <input type="text" id="pembahasan" name="pembahasan" class="input-field"
                                    placeholder="Politik Luar Desa" />
                            </div>
                        </div>
                        <div class="form-col">
                            <!-- Tambahkan form kecil di sini -->
                        </div>
                    </div>
                    <div style="display: flex; justify-content: flex-end;">
                        <button type="button" class="button-terima" onclick="terimaPengumuman()">Terima</button>
                        <button type="button" class="button-tolak" onclick="tolakPengumuman()">Tolak</button>
                    </div>
