...
<body>
    ...
    <div id="mySidebar" class="sidebar">
        ...
        <div class="profile-container">
            ...
            <div class="admin-name">Admin RT & RW</div>
        </div>
        <div class="garis-pembatas-profile"></div>
        <a class="active" href="{{ route('rtrw.index') }}">Pengumuman</a>
        <a href="{{ route('rtrw.laporantamu') }}">Laporan Tamu</a>
    </div>
    ...
    <div id="main">
        ...
        <div class="content">
            ...
            <div class="form-container">
                ...
                <form action="{{ route('rtrw.pengumumanStore') }}" action="get" onsubmit="return validateForm()">
                    @csrf
